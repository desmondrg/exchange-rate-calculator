        ...
        <div className='page'>
            <div className='page-header' style={{backgroundImage: `url('${props.heroImageUrl}')`}}>
                ...
                <div className='w-100 h-75 c-flex'>
                   {props.heroTitle && <Typography variant='h1' color='white' sx={{fontSize: isTabletOrMobile ? '24px' : '34px', marginBottom: '0.5em'}}>{props.heroTitle}</Typography>}
                    {props.heroSubtitle && <Typography variant='h2' color='white' sx={{fontSize: isTabletOrMobile ? '16px' : '24px'}}>{props.heroSubtitle}</Typography>}
                </div>
